        ...
        <div class="row g-0 h-100">
            <div class="col-md-6 login-left">
                <div class="h-100 d-flex flex-column justify-content-between">
                    <div>
                        ...
                        <p class="app-subtitle">Platform terpadu pengelolaan data yang aman</p> 
                        <div class="mt-4">
                        </div>
                    </div>
            ...
            <div class="col-md-6 login-right">
                <div class="login-header">
                    <h2 class="login-title">Halo, Selamat Datang</h2>
                    <p class="login-description">Masuk untuk mengakses Dashboard anda</p>
                </div>
                @if(session('success'))
